...
import React__default, { useRef, useContext, createElement, useDebugValue, useState, useEffect, useImperativeHandle, Children, forwardRef, createContext, useCallback, useMemo, useLayoutEffect } from 'react';
...
function ColorRing(_a) {
    ...
    return !visible ? null : (React__default.createElement("svg", __assign$4({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width: width, height: height, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid", className: wrapperClass, style: wrapperStyle, "aria-label": ariaLabel, "data-testid": "color-ring-svg" }, DEFAULT_WAI_ARIA_ATTRIBUTE),
        React__default.createElement("defs", null,
            React__default.createElement("mask", { id: "ldio-4offds5dlws-mask" },
                React__default.createElement("circle", { cx: "50", cy: "50", r: "26", stroke: "#fff", strokeLinecap: "round", strokeDasharray: "122.52211349000194 40.840704496667314", strokeWidth: "9", transform: "rotate(198.018 50 50)" },
                    React__default.createElement("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50;360 50 50", keyTimes: "0;1", dur: "1s", repeatCount: "indefinite" })))),
        React__default.createElement("g", { mask: "url(#ldio-4offds5dlws-mask)" },
            React__default.createElement("rect", { x: "14.5", y: "0", width: "15", height: "100", fill: colors[0] },
                React__default.createElement("animate", { attributeName: "fill", values: colors.join(';').toString(), keyTimes: "0;0.25;0.5;0.75;1", dur: "1s", repeatCount: "indefinite", begin: "-0.8s" })),
            React__default.createElement("rect", { x: "28.5", y: "0", width: "15", height: "100", fill: colors[1] },
                React__default.createElement("animate", { attributeName: "fill", values: colors.join(';').toString(), keyTimes: "0;0.25;0.5;0.75;1", dur: "1s", repeatCount: "indefinite", begin: "-0.6s" })),
            React__default.createElement("rect", { x: "42.5", y: "0", width: "15", height: "100", fill: colors[2] },
                React__default.createElement("animate", { attributeName: "fill", values: colors.join(';').toString(), keyTimes: "0;0.25;0.5;0.75;1", dur: "1s", repeatCount: "indefinite", begin: "-0.4s" })),
            React__default.createElement("rect", { x: "56.5", y: "0", width: "15", height: "100", fill: colors[3] },
                React__default.createElement("animate", { attributeName: "fill", values: colors.join(';').toString(), keyTimes: "0;0.25;0.5;0.75;1", dur: "1s", repeatCount: "indefinite", begin: "-0.2s" })),
            React__default.createElement("rect", { x: "70.5", y: "0", width: "15", height: "100", fill: colors[4] },
                React__default.createElement("animate", { attributeName: "fill", values: colors.join(';').toString(), keyTimes: "0;0.25;0.5;0.75;1", dur: "1s", repeatCount: "indefinite", begin: "0s" })))));
}
...
React__default.forwardRef(function (props, ref) {
    ...
    return React__default.createElement("div", __assign$1({}, props, { ref: mergeRefs([localRef, ref]) }));
});
...
var TransformComponent = function (_a) {
    ...
    return (React__default.createElement("div", __assign$1({}, wrapperProps, { ref: wrapperRef, className: "react-transform-wrapper ".concat(styles.wrapper, " ").concat(wrapperClass), style: wrapperStyle }),
        React__default.createElement("div", __assign$1({}, contentProps, { ref: contentRef, className: "react-transform-component ".concat(styles.content, " ").concat(contentClass), style: contentStyle }), children)));
};
...
function convertFromNode(input, options) {
    ...
    switch (node.nodeType) {
        case 1: {
            // regular dom-node
            return React$1.createElement(parseName(node.nodeName), parseAttributes(node, key), parseChildren(node.childNodes, level, options));
        }
        case 3: {
            // textnode
...
var cacheStore;
var ReactInlineSVG = class extends React$1.PureComponent {
  constructor(props) {
    super(props);
  ...
  getElement() {
    try {
      ...
      if (!element || !React$1.isValidElement(element)) {
  ...
  render() {
    ...
    if (element) {
      return React$1.cloneElement(element, { ref: innerRef, ...elementProps });
    }
...
function InlineSVG(props) {
  ...
  const { loader } = props;
  const hasCallback = React$1.useRef(false);
  const [isReady, setReady] = React$1.useState(cacheStore.isReady);
  React$1.useEffect(() => {
...
const DragSvg = _ref => {
  ...
  const handlePointerDownRotate = useCallback(e => {
    e.stopPropagation();
    setDisabledZoomComponent(true);
  ...
  const mouseUpRotate = useCallback(e => {
    e.stopPropagation();
    let x2 = e.clientX,
      y2 = e.clientY,
  ...
  const handlePointerMoveRotate = useCallback(e => {
    e.stopPropagation();
    let x2 = e.clientX,
      y2 = e.clientY,
      x1 = ref.current?.getBoundingClientRect().x + width / 2,
...
root.render(jsx(React__default.StrictMode, {
  children: jsx(App, {})
}));
